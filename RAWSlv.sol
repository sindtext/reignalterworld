...
contract RAWSlv is ERC20, AccessControl, ERC20Permit, ReentrancyGuard {
    constructor() payable
        ERC20("Reign Alter World Silver", "RAWSlv")
        ERC20Permit("Reign Alter World Silver")
    {
    ...
    uint256 internal maxSupply = 1280000000000;
